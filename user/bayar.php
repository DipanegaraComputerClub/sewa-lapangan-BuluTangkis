...
// Pagination
$jmlHalamanPerData = 5;
$jumlahData = count(query("SELECT sewa.*, lapangan.nm, bayar.order_id, bayar.konfirmasi
FROM sewa
...
$sewa = query("SELECT sewa.*, lapangan.nm, bayar.order_id, bayar.konfirmasi
FROM sewa
JOIN lapangan ON sewa.idlap = lapangan.idlap
left JOIN bayar ON sewa.idsewa = bayar.idsewa
...
<a href="" data-bs-toggle="modal" data-bs-target="#hapusModal' . $row["idsewa"] . '" class="btn btn-danger">Hapus</a>';
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        ...
                        <form action="../checkout.php" method="post" enctype="multipart/form-data">
                          ...
                          <input type="hidden" name="total" value="<?= $row["tot"]; ?>">
                          <div class="modal-body">
                            <!-- konten form modal -->
                            <div class="row justify-content-center align-items-center">
                              <div class="col">
                              ...
                              <div class="input-group ">
                                ...
                                <input type="number" name="total" class="form-control" id="total" value="<?= $row["tot"]; ?>" disabled>
                              </div>
                              <!-- <div class="mt-3">
                          ...
                          <div class="mt-3 mx-3">
                            <h6 class=" text-center">Status : Belum Bayar</h6>
                          </div>
                          <div class="modal-footer">
                      ...
                      <div class="modal-content">
                        ...
                        <form action="" method="post">
                          <div class="modal-body">
                            ...
                            <div class="row justify-content-center align-items-center">
                              <!-- <div class="mb-3">
                                <img src="../img/<?= $row["order_id"]; ?>" alt="gambar lapangan" class="img-fluid">
                              </div> -->
                              <div class="col">
                                <div class="mb-3">
                                  <label for="exampleInputPassword1" class="form-label">Jam Main</label>
                          ...
                          <div class="mt-3 mx-3">
                            <h6 class="text-center">Status : <?= $row["konfirmasi"]; ?></h6>
                          </div>
                          <div class="modal-footer">
  ...
  <!-- footer -->
  <footer class="fixed-bottom py-1 mt-1">
    <div class="credit">
