...
// Pagination
$jmlHalamanPerData = 3;
$jumlahData = count(query("SELECT sewa.idsewa,user.nama_lengkap,sewa.tgl_pesan,sewa.jmulai,sewa.lama,sewa.tot,bayar.*,bayar.konfirmasi
FROM sewa
...
$pesan = query("SELECT sewa.idsewa,user.nama_lengkap,sewa.tgl_pesan,sewa.jmulai,sewa.lama,sewa.tot,bayar.*,bayar.konfirmasi
FROM sewa
JOIN user ON sewa.iduser = user.id_user
          ...
          <tbody class="text">
            ...
            <?php foreach ($pesan as $row) : ?>
              <tr>
                ...
                <td><?= $row["tgl_pesan"]; ?></td>
                <td><?= $row["jmulai"]; ?></td>
                <td><center><?= $row["lama"]; ?></center></td>
                <td><?= $row["tot"]; ?></td>
                <td><?= $row["order_id"]; ?></td>
                <td><center><?= $row["payment_type"]; ?></center></td>
